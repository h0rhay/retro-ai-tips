    ...
    <div className="min-h-screen bg-black text-white font-pixel">
      ...
      <section className="relative px-4 py-16 sm:py-24 border-b-4 border-[#25f79c] bg-[#5acffa]">
        <div className="container mx-auto max-w-5xl">
          <div className="retro-box p-6 sm:p-8 bg-[#091c69] border-4 border-[#25f79c] relative">
            ...
            <h1 className="text-4xl sm:text-6xl font-bold text-center mb-4 text-[#25f79c] retro-text">RETRO QUEST</h1>
            <p className="text-xl sm:text-2xl text-center mb-8 text-[#39ff14]">Press START to begin your adventure!</p>

            <div className="flex justify-center">
              <button className="retro-button px-8 py-3 bg-[#25f79c] text-black font-bold text-xl border-4 border-white hover:bg-[#5df8b6] transition-colors">
                START GAME
              </button>
            </div>
          </div>
      ...
      <section className="px-4 py-16 bg-[#091c69]">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl sm:text-4xl font-bold mb-12 text-center text-[#39ff14] retro-text">
            SELECT YOUR QUEST
          </h2>
              ...
              <Link href={quest.link} key={index} className="retro-card group">
                <div className="bg-[#5acffa] border-4 border-[#25f79c] p-4 h-full transition-transform hover:translate-y-[-5px] hover:shadow-[0_0_10px_#25f79c]">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="text-[#091c69] font-bold">LVL {quest.level}</div>
                  </div>

                  <h3 className="text-xl font-bold mb-2 text-[#091c69]">{quest.title}</h3>
                  ...
                  <div className="flex justify-between items-center mt-auto pt-4 border-t-2 border-[#25f79c] border-dashed">
                    <span className="text-[#091c69] font-bold">{quest.points} PTS</span>
      ...
      <section className="px-4 py-16 bg-[#5acffa]">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-center text-[#091c69] retro-text">PRO TIPS</h2>
